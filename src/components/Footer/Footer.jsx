        ...
        <div className="footer-grid reveal-stagger-list">
          ...
          <div className="footer-col">
            ...
            <p className="footer-contact-text">
              Have questions, feedback, or want to collaborate? Feel free to reach out to me directly anytime.
            </p>
            <a href={`mailto:${APP_DOWNLOAD_LINKS.contactEmail}`} className="footer-contact-btn">
              <Mail size={16} />
              <span>Contact Me</span>
            </a>

            <div className="footer-socials">
              <a href={APP_DOWNLOAD_LINKS.github} target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="social-icon">
              ...
              <a href={APP_DOWNLOAD_LINKS.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="social-icon">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
